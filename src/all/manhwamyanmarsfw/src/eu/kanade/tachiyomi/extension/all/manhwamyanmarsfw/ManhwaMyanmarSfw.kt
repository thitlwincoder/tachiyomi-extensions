package eu.kanade.tachiyomi.extension.all.manhwamyanmarsfw
...
open class ManhwaMyanmarSfw : HttpSource() {

    override val name = "Manhwa Myanmar"
    override val baseUrl = "https://manhwamyanmar.com"
    override val lang = "my"
    override val supportsLatest = true

    private val chapterBaseHost = "https://webtoon.manhwamyanmar.com"
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        val document = response.asJsoup()
        return document.select("a[href*='webtoon.manhwamyanmar.com']")
            .mapNotNull { a ->
                val href = a.attr("href")
                if (!href.contains("webtoon.manhwamyanmar.com")) return@mapNotNull null
